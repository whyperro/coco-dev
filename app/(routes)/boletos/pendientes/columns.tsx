...
export const columns: ColumnDef<Ticket>[] = [
  {
    ...
    cell: ({ row }) => {
      return <div className="text-center font-bold flex gap-2 items-center justify-center"><TicketMinus className="size-4 text-yellow-600" /> {row.original.ticket_number ?? "N/A"}</div>
    },
  },
  {
